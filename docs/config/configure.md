...
:::info PRE-REQUIRE
除了零配置相关内容，请确保你已经知晓如何正确进行 Nocalhost 配置，如果还不知如何进行配置，请阅读[Nocalhost 概述 —— 是什么，怎么配置，有哪些特性？](config-overview-en.md)来进行了解。
:::
...
请参考 [Nocalhost 开发配置的特性](config-overview-en.md#四、开发配置的特性)