...
function checkFile (item) {
	return item?.outerHTML.indexOf('js/three.min.js') !== -1 || 
...
export default function Home() {
	...
	return (
		<div className={styles.mdContainer}>
			{
				showVideoModal && <VideoModal setShowVideoModa={setShowVideoModa}></VideoModal>
			}
				...
				<nav className={clsx(styles.mdGridTop, styles.mdHeaderNav)}>
					...
					<div className={styles.mdTabsBlock}>
						<ul className={styles.mdTabsList}>
							...
							<li className={clsx(styles.mdTabsItem, styles.xdHide)}>
								<a href="https://github.com/nocalhost/nocalhost" target="_blank" title="Material for MkDocs Insiders" className={styles.githubNav} rel="noreferrer">
					...
					<div className={styles.txHero}>
						<div className={styles.txHearHeaderBg}>
							<div className={styles.txHeroHeaderBgContainer}>
								<div className={styles.txHeroHeaderBgLavender}>
								</div>
							</div>
							<div className={styles.txHeroHeaderBgContainerEnd}>
								<div className={styles.txHeroHeaderBgBlue}>
								</div>
							</div>
							<div className={styles.txHeroHeaderBgContainerStart}>
								<div className={styles.txHeroHeaderBgBlack}>
								</div>
							</div>
							<div className={styles.txHeroHeaderBgContainerStart}>
								<div className={styles.txHeroHeaderBgWhite}>
								</div>
							</div>
							<div className={styles.txHeroHeaderBgContainer}>
								<div className={styles.txHeroElementBubbles}>
								</div>
							</div>
						</div>					
						<div className={clsx(styles.txGeroContent, styles.txGeroContent1)}>
							<div className={styles.headerContent}>
								...
								<h1><Translate>Goodbye, localhost!</Translate></h1>
								...
								<div className={styles.txHeroContentBtns}>
									...
									<div className={styles.githubBtn}>
										<a href="https://github.com/nocalhost/nocalhost" target="_blank" title="Material for MkDocs Insiders" rel="noreferrer">
											<img className={styles.githubLogo} src="img/home/mark-github.svg"></img>
                                        GitHub
										</a>
									</div>
							...
							<div className={styles.cardsGroupContainer}>
								<div className={styles.cardsGroup}>
									<div className={styles.cardsGroupSection}>
										<strong><Translate>It&apos;s a</Translate></strong>
										...
										<p className={styles.detail}>
											<Translate>Code changes can instantly synchronize from IDE to cloud, see changes under seconds, without image commit, push or pull cycles.</Translate>
										</p>
									...
									<div className={styles.cardsGroupSection} style={{ backgroundColor: '#0f2b34' }}>
										...
										<p className={styles.detail}>
											<Translate>Developers can share the same development environment across the team, enjoying team collaboration.</Translate>
										</p>
										<div className={styles.icon}>
									...
									<div className={styles.cardsGroupSection} style={{ backgroundColor: '#0f2b34' }}>
										...
										<p className={styles.detail}>
											<Translate>Nocalhost can help developers to build Kubernetes applications much easier and faster.</Translate>
									...
									<div className={clsx(styles.cardsGroupSection3, styles.cardsGroupSection)} style={{ backgroundColor: '#fff' }}>
										<strong><Translate>It&apos;s a</Translate></strong>
										<div className={styles.title}>
											<p>
										...
										<p className={styles.detail}>
											<Translate>Developers can directly develop and debug remote designated microservices under the complex framework through Nocalhost.</Translate>
								...
								<section>
									<div className={styles.devModeIntro}>
										...
										<div className={styles.devModeName}>
											...
											<p><Translate>Everyone codes in an isolated way.</Translate></p>
										</div>
									</div>
									<div className={styles.devModeContent}>
										...
										<ul className={styles.localhostList}>									
											<li><Translate>Hard to develop large applications with limited local resources</Translate></li>
											<li><Translate>Difficult to setup and maintain the development environment</Translate></li>
											<li><Translate>Difficult for collaborative debugging</Translate></li>
											<li><Translate>Gap between development environment and production environment</Translate></li>
										</ul>
									</div>                              
								</section>
								...
								<section>
									<div className={styles.devModeIntro}>
										...
										<div className={styles.devModeName}>
											...
											<p><Translate>Nocalhost can empower any Kubernetes Cluster and upgrade it to a collaborative development environment for developers.</Translate></p>
										</div>
									</div>
									<div className={styles.devModeContent}>
										...
										<ul className={styles.nocalhostList}>
											<li><Translate>Easy to handle large application development with flexible cloud resources</Translate></li>
											<li><Translate>Environment provisioning on demand</Translate></li>
											<li><Translate>Easy to share the same development environment and collaborative debugging</Translate></li>
											<li><Translate>Close to production environment</Translate></li>
										</ul>
									</div>                              
								</section>
							</div>
						...
						<div className={clsx(styles.txGeroContent, styles.txHeroContent4)}>
							...
							<p><Translate>Explore the difference between development locally and development on the cloud.</Translate></p>
						...
						<div className={styles.whoUse}>
							...
							<div className={styles.whoUseCardBox}>
								<div className={styles.whoUseCar}>
									<img src="img/home/consumer-1.png" className={styles.logo}></img>
									<div className={styles.title}>
										<Translate id="Litchi.title">Litchi Microclass</Translate>
									
									</div>
									<div className={styles.text}>
										<Translate id="Litchi.info">Litchi Microclass is a platform dedicated to the sharing of public knowledge, and all functions of the whole platform are free for life. Here, everyone can start and share classes anytime, anywhere, or listen to classes and learn. Use Nocalhost to improve the development efficiency of infrastructure components.</Translate>
								...
								<div className={styles.whoUseCar}>
									...
									<div className={styles.text}>
										<Translate id="HongyaTechnology.info">Hongya Technology is a technology company that provides superior services for information technology-related majors. Its business includes teaching products and school-enterprise cooperation. It uses Nocalhost to improve business R&D efficiency (green pepper classroom).</Translate>
								
									</div>
								</div>
								<div className={styles.whoUseCar}>
									<img src="img/home/consumer-3.png"  className={styles.logo}></img>
									<div className={styles.title}>
										<Translate id="GengmeiApp.title">Gengmei App </Translate>
									
									</div>
									<div className={styles.text}>
										<Translate id="GengmeiApp.info">Gengmei App is a plastic surgery communication community, a medical beauty e-commerce platform, and a reputation database for plastic surgery doctors. Its business covers China, South Korea, Thailand, Singapore, etc., and Nocalhost is used to improve business R&D efficiency.</Translate>
								...
								<div className={styles.whoUseCar}>
									...
									<div className={styles.text}>
										<Translate id="XiaoyingTechnology.info">Xiaoying Technology is an Internet company focusing on mobile video creation tools and services. The company was established in June 2012 and is headquartered in Hangzhou. Round of financing. Use Nocalhost to improve the research and development efficiency of machine learning projects in the K8s environment.</Translate>								
									</div>
								</div>
							</div>
						</div>
			...
			<footer id="nocalhost-footer" className={styles.footer}>
				<div className={styles.footerContent}>
                    ...
                    &nbsp;&&nbsp; 
						<a href="https://github.com/nocalhost/nocalhost/graphs/contributors">Nocalhost Project Authors</a>
                    © 2021
					</p>
				</div>				
			</footer>
