...
- Release “standalone version”. Release “standalone version”. Now can start application development by just add `KubeConfig` for existing Kubernetes clusters and workloads
