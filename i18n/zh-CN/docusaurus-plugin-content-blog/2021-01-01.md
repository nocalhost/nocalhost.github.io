...
<figure className="img-frame">
  <img className="gif-img" src={useBaseUrl('/img/blog/2021-01-01/circle-zh-cn.png')} />
</figure>
...
[一起使用 Nocalhost 进行简单快捷的云原生应用开发](/docs/quick-start)

以 Nocalhost 内置的 Demo - Bookinfo 为例，开发 Productpage 这个微服务的过程大大简化：

1. 连接远程 Kubernetes 集群
2. 选择需要开发的工作负载，进入开发模式
3. Nocalhost IDE 插件会自动将源代码同步到远程 `DevContainer`
4. 代码更改秒级生效，并不需重建映像或重新启动远程 POD
...
目前，腾讯云 [CODING DevOps](http://coding.net/)（近 200 微服务）正在使用 Nocalhost 进行开发，实践验证 Nocalhost 能够大大提高开发效率，缩短循环反馈。

## 开源与社区共建

Nocalhost 目前是 100% 开源的，并已经进入 CNCF Landscape: [https://landscape.cncf.io/](https://landscape.cncf.io/)，[代码托管在 Github](https://github.com/nocalhost/nocalhost)。

我们并遵循 Apache-2.0 开源协议，可以免费使用。

想了解更多关于 Nocalhost 的信息，欢迎查阅[Nocalhost 文档](/docs/introduction)。